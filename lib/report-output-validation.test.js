...
// generator), and index.report-validation.test.js (the enforcement
// suite). api/*.js referencing it remains forbidden - in particular
// api/generate.js's zero-import containment contract must hold.
{
  const ALLOWED = ['index.html', 'embed-report-validation.js', 'report-validation.test.js'];
  const importers = [];
